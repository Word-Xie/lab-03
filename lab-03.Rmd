...
author: "Wei Xie, Yancheng Zhu, Qinrui Chen, Dongtian Huang, Kaige Wei and User6 - Team Name"
date: "`r Sys.Date()`"
...
_data are in layers and may not easy to analyse_
...
ggplot(data = staff_long,
  ...
  labs(
    x = "Year",
    y = "Percent",
    title = "Staff in Different Faculty"
  )
